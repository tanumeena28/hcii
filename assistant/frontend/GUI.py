...
from PyQt5.QtGui import (QIcon, QMovie, QPixmap, QColor, QTextCharFormat, 
                         QTextBlockFormat, QFont, QPainter)
from PyQt5.QtWidgets import (QApplication, QWidget, QVBoxLayout, QHBoxLayout, 
                             QTextEdit, QFrame, QSizePolicy, QLabel, 
                             QPushButton, QMainWindow, QStackedWidget)
