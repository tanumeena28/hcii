from PySide6.QtWidgets import QApplication, QWidget, QMainWindow, QStackedWidget, QTextEdit, QVBoxLayout, QHBoxLayout, QPushButton, QFrame, QLabel, QSizePolicy
from PySide6.QtGui import QIcon, QMovie, QColor, QTextCharFormat, QTextCursor, QPainter, QPixmap
...
class ChatSection(QWidget):
    def __init__(self, parent=None):
        ...
        movie = QMovie(GraphicsDirectoryPath("Jarvis.gif")) # Changed to Jarvis.gif
        max_gif_size_w = 270
...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        self.home_button = QPushButton(QIcon(GraphicsDirectoryPath("Home.png")), "Home")
        self.message_button = QPushButton(QIcon(GraphicsDirectoryPath("Chats.png")), "Chat")
